            ...
            <form method="POST" action="{{ route('religion.store') }}">
                ...
                <div class="item form-group row">
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <label>धर्म <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-6 mt-2">
                        ...
                        <a href="{{ route('religion.index') }}" class="btn btn-primary">रद्द</a>
                    </div>
                </div>
            </form>
        </div>
                        ...
                        <table id="example" style="min-width: 845px" class="display table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('religion.edit', $religion->religion_id) }}" data-toggle="tooltip" title="Edit">
