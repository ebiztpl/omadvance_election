    ...
    @push('scripts')
        <script>
            $(document).ready(function() {
                ...
                // Include filter value in DataTable ajax call
                ...
                // Hide loader on DataTable request complete
                table.on('xhr.dt', function() {
                    $('#loader-wrapper').hide();
                });

                // Update complaint count after each table draw
                table.on('draw', function() {
                    let info = table.page.info();
                    $('#complaint-count').text(info.recordsDisplay); // filtered count
                });
