                        ...
                        <ul class="nav nav-tabs nav-filters mb-1">
                            <li class="nav-item">
                                <a class="nav-link filter-link {{ request('filter') === 'forwarded_manager' ? 'active' : '' }}"
                                    style="color: black"
                                    href="{{ route('operator.suchna.view', ['filter' => 'forwarded_manager']) }}">निर्देशित</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link filter-link {{ request('filter') === null ? 'active' : '' }}"
                                    style="color: black" href="{{ route('operator.suchna.view') }}">सभी</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link filter-link {{ request('filter') === 'not_opened' ? 'active' : '' }}"
                                    style="color: black"
                                    href="{{ route('operator.suchna.view', ['filter' => 'not_opened']) }}">नई सूचनाएँ</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link filter-link {{ request('filter') === 'cancel' ? 'active' : '' }}"
                                    style="color: black"
                                    href="{{ route('operator.suchna.view', ['filter' => 'cancel']) }}">रद्द
                                    सूचनाएँ</a>
                            </li>
                             ...
                             <li class="nav-item">
                                <a class="nav-link filter-link {{ request('filter') === 'sammilit_done' ? 'active' : '' }}"
                                    style="color: black"
                                    href="{{ route('operator.suchna.view', ['filter' => 'sammilit_done']) }}">सम्मिलित हुए
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link filter-link {{ request('filter') === 'reference_null' ? 'active' : '' }}" style="color: black"
                                    href="{{ route('operator.suchna.view', ['filter' => 'reference_null']) }}">रेफरेंस नहीं है</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link filter-link {{ request('filter') === 'reference' ? 'active' : '' }}" style="color: black"
                                    href="{{ route('operator.suchna.view', ['filter' => 'reference']) }}">रेफरेंस है</a>
                            </li>
                        </ul>
