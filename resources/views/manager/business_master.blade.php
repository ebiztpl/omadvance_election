            ...
            <form method="POST" action="{{ route('business.store') }}">
                ...
                <div class="item form-group row">
                    ...
                    <div class="col-md-6 mt-2">
                        ...
                        <a href="{{ route('business.index') }}" class="btn btn-primary">रद्द</a>
                    </div>
                </div>
            </form>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="example" style="min-width: 845px" class="display table-bordered">
                            ...
                            <tbody>
                                @foreach($businesss as $index => $business)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ $business->business_name }}</td>
                                    <td>
                                        <a href="{{ route('business.edit', $business->id) }}" data-toggle="tooltip" title="Edit">
