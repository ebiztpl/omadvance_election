            ...
            <form method="POST" action="{{ route('interest.store') }}">
                ...
                <div class="item form-group row">
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <label>रुचि <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-6 mt-2">
                        ...
                        <a href="{{ route('interest.index') }}" class="btn btn-primary">रद्द</a>
                    </div>
                </div>
            </form>
        </div>
                        ...
                        <table id="example" style="min-width: 845px" class="display table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('interest.edit', $interest->id) }}" data-toggle="tooltip" title="Edit">
