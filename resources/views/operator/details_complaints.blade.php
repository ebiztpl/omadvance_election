...
<div class="container">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body row g-3">
            ...
            <div class="col-md-12" style="margin-top: 10px;">
                ...
                <a href="{{ asset('assets/upload/complaints/' . $complaint->issue_attachment) }}" class="btn btn-primary" target="_blank">Open Attachment</a>
                @else
                <p>No attachment</p>
                @endif
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        <p><strong>Date:</strong> {{ $reply->reply_date ? \Carbon\Carbon::parse($reply->reply_date)->format('d-m-Y') : 'N/A' }}</p>
                        @php
                        $replyFromName = ($reply->reply_from == 1) ? ($reply->complaint->user->name ?? 'User') : 'BJS Team';
                        @endphp
                        ...
                        <a href="{{ asset($reply->cb_photo) }}" class="btn btn-primary mb-3" target="_blank">Open Attachment</a>
                        @else
                        <p>No attachment</p>
                        @endif
                        ...
                        <a href="{{ asset($reply->ca_photo) }}" class="btn btn-primary" target="_blank">Open Attachment</a>
                        @else
                        <p>No attachment</p>
                        @endif
                        ...
                        <a href="{{ asset($reply->c_video) }}" class="btn btn-primary" target="_blank">{{$reply->c_video}}</a>
                        @else
                        <p>No attachment</p>
                        @endif
                    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('operator_complaint.reply', $complaint->complaint_id) }}" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
                    <div class="col-md-8">
                    ...
                    <div class="col-md-2">
                        ...
                        <label class="form-label mt-3">Complaint Status: <span class="tx-danger" style="font-size: 11px; color: red;">*</span></label>
