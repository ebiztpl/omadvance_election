                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <select disabled class="form-control">
                                ...
                                <option {{ $registration->membership == 'समर्पित कार्यकर्ता' ? 'selected' : '' }}>समर्पित
                                    कार्यकर्ता</option>
                                <option {{ $registration->membership == 'सक्रिय कार्यकर्ता' ? 'selected' : '' }}>सक्रिय
                                    कार्यकर्ता</option>
                                <option {{ $registration->membership == 'साधारण कार्यकर्ता' ? 'selected' : '' }}>साधारण
                                    कार्यकर्ता</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <select disabled class="form-control">
                                @foreach (['सामान्य', 'पिछड़ा वर्ग', 'अनुसूचित जाति', 'आदिवासी जाति', 'अन्य'] as $caste)
                                    <option value="{{ $caste }}"
                                        {{ $registration->caste == $caste ? 'selected' : '' }}>{{ $caste }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <select disabled class="form-control">
                                ...
                                @foreach ($qualifications as $q)
                                    <option value="{{ $q }}"
                                        {{ $registration->education == $q ? 'selected' : '' }}>{{ $q }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                ...
                <fieldset class="mt-5">
                    ...
                    <div class="row  mt-3">
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            ...
                            <img src="{{ asset('assets/upload/step2/' . $step2['voter_front']) }}" width="200"
                                alt="Voter ID Front" class="img-thumbnail">
                        </div>

                        <div class="col-lg-3 col-md-6 col-12">
                            <label class="form-label d-block">वोटर आई.डी. पीछे का फोटो</label>
                            <img src="{{ asset('assets/upload/step2/' . $step2['voter_back']) }}" width="200"
                                alt="Voter ID Back" class="img-thumbnail">
                        </div>
                    </div>
                </fieldset>
                <br />
                ...
                <fieldset class="mt-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mt-3">
                            <label class="form-label fw-bold">सदस्यता का कारण / उद्देश्य: आप बीजेएस के सदस्य क्यों बन रहे
                                हैं</label>
