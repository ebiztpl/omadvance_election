@extends('mastermanager::layouts.login_layout')
                ...
                <div class="row no-gutters">
                    <div class="col-xl-12">
                        <div class="auth-form">
                            ...
                            <form id="registerForm" method="POST" action="{{ route('master.register') }}">
                                @csrf
                                {{-- Name --}}
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#name').on('input', function() {
                    ...
                    lastRequest = $.ajax({
                        url: "{{ route('master.checkUsername') }}",
                        type: "POST",
                        data: {
                            _token: "{{ csrf_token() }}",
                            name: name
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                $('#ajax-message').html('<div class="alert alert-danger">' +
                                    response.message +
                                    '</div>');
                            }
                        }
