...
<head>
    <meta charset="utf-8">
    <title>@yield('title', 'Sampark Dashboard')</title>
...
<body>
    ...
    <div id="main-wrapper">
        @include('mastermanager::layouts.header')
        @include('mastermanager::layouts.sidebar')
        <div class="content-body">
            <div class="container-fluid">
                @yield('content')
            </div>
        </div>
        @include('mastermanager::layouts.footer')
    </div>
