...
class FollowupStatus extends Model
{
    ...
    public function followup_status_text()
    {
        return match ($this->followup_status) {
            0 => 'Not Done',
            1 => '<button class="btn btn-warning" style="font-size: 12px">फॉलोअप किया गया है, लेकिन कार्य अपूर्ण है</button>',
            2 => '<button class="btn btn-info" style="font-size: 12px">पूर्ण</button>',
            default => 'Unknown',
        };
    }
